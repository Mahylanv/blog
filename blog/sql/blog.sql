...
CREATE TABLE `article` (
  ...
  `img_principal` varchar(240) NOT NULL
...
--
ALTER TABLE `categorie`
  MODIFY `id_catégorie` int(3) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `relation_article_categorie`
  ...
  ADD CONSTRAINT `relation_article_categorie_ibfk_2` FOREIGN KEY (`id_catégorie`) REFERENCES `categorie` (`id_catégorie`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
